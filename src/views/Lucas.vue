<template>
   <div class="header">
      <div class="user">
         <div class="inicio" >
            <h1> Digite o usúario do GitHub <img class="gitImage" src="https://pngimg.com/uploads/github/github_PNG58.png" alt=""></h1>
         </div>
         <v-form class="conteudo"
            @submit.prevent="">
            ...
            <div class="image">
               <img :src="user.avatar_url" disable:height="400px" width="400px" style="border-radius: 300px" />
            </div>
            <div class="infoGit">
               <div class="name">
               ...
               <div class="public_repos">
                  <p v-if="user.public_repos"> {{"Repositórios Públicos: " + user.public_repos}} </p>
                  <p v-else></p>
               </div>
               <div class="public_gists">
                  <p v-if="user.public_gists"> {{"Repositórios Gist: " + user.public_gists}} </p>
                  <p v-else></p>
               </div>
               <div class="followers">
            ...
            <a v-if="href" id="hrefGit" class="mr-4 v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default" 
               color="error" :href="href"> Clique aqui para acessar o perfil no GitHub</a>
         </v-form>
      </div>
   </div>
</template>
